-- DDL for Snowflake Stored Procedure: DEV_DB.BBB.SP_CDC_LOAD
-- Generated Example SQL

CREATE OR REPLACE PROCEDURE DEV_DB.BBB.SP_CDC_LOAD(
    STAGE_NAME VARCHAR,
...
BEGIN
    ...
    INSERT INTO DEV_DB.BBB.TBL_INFO (name, category, description, value_amount)
