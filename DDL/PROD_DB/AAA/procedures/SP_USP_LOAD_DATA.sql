-- DDL for Snowflake Stored Procedure: PROD_DB.AAA.SP_USP_LOAD_DATA
-- Generated Example SQL

CREATE OR REPLACE PROCEDURE PROD_DB.AAA.SP_USP_LOAD_DATA(
    STAGE_NAME VARCHAR,
...
BEGIN
    ...
    INSERT INTO PROD_DB.AAA.TBL_INFO (name, category, description, value_amount)
