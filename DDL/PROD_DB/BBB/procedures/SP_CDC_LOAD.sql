-- DDL for Snowflake Stored Procedure: PROD_DB.BBB.SP_CDC_LOAD
-- Generated Example SQL

CREATE OR REPLACE PROCEDURE PROD_DB.BBB.SP_CDC_LOAD(
    STAGE_NAME VARCHAR,
...
BEGIN
    ...
    INSERT INTO PROD_DB.BBB.TBL_INFO (name, category, description, value_amount)
