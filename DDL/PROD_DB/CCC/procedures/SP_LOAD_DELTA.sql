-- DDL for Snowflake Stored Procedure: PROD_DB.CCC.SP_LOAD_DELTA
-- Generated Example SQL

CREATE OR REPLACE PROCEDURE PROD_DB.CCC.SP_LOAD_DELTA(
    STAGE_NAME VARCHAR,
...
BEGIN
    ...
    INSERT INTO PROD_DB.CCC.TBL_INFO (name, category, description, value_amount)
